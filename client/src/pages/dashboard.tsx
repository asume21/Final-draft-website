...
export default function Dashboard() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--brand-dark)', color: 'var(--brand-text)', padding: '32px' }}>
        ...
        <div className="space-y-8">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2">
              Welcome to <span style={{ background: 'linear-gradient(135deg, var(--accent-teal), var(--accent-red))', backgroundClip: 'text', color: 'transparent' }}>CodedSwitch</span>
            </h1>
            <p style={{ color: 'var(--brand-text-muted)', fontSize: '18px' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {stats.map((stat, index) => (
              <Card key={index} style={{ backgroundColor: 'var(--brand-card)', borderColor: 'var(--brand-border)' }}>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px', color: 'var(--accent-teal)', fontSize: '14px' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {quickActions.map((action, index) => (
                <Link key={index} href={action.href}>
                  <Card style={{ backgroundColor: 'var(--brand-card)', borderColor: 'var(--brand-border)', cursor: 'pointer', transition: 'all 0.3s ease' }}>
                    <CardContent className="p-6 text-center">
                      <div style={{ width: '48px', height: '48px', backgroundColor: 'rgba(20, 184, 166, 0.2)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px', margin: '0 auto 16px auto' }}>
                        <action.icon style={{ color: 'var(--accent-teal)', width: '24px', height: '24px' }} />
                      </div>
